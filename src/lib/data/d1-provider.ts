...
//   - عند فشل أي استعلام جوهري نسقط بشكل آمن إلى مزوّد seed.
//
// الأمان: كل القيم المتغيّرة تمر عبر .bind(); لا يوجد string interpolation
// لقيم المستخدم. الـ placeholders (`?N`) هي وحدها التي تُبنى ديناميكيًا
// من عدد العناصر، وهي ثوابت حرفية، لا قيم مستخدم.
// =============================================================================
